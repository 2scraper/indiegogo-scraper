...
**"indiegogo-scraper security"** in the subject — otherwise it lands in a
...
- **Bypassing Indiegogo's bot protection.** This scraper drives an
  ordinary browser and passes challenges the way a browser does. Anything
  about how a challenge vendor behaves is not a vulnerability in this
  repository.
- **The scraper stopped working.** Indiegogo changing its markup is
